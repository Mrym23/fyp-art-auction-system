            ...
            <nav id="header" class="w-full sticky z-30 top-0">
                <div class="w-full container mx-auto flex flex-wrap bg-white border-b border-yellow-200 items-center justify-between mt-0 px-4 py-2">
                                ...
                                <li>
                                    <div class="dropdown group inline-block relative">
                                        ...
                                        <ul class="dropdown-menu absolute hidden text-gray-700 pt-1" style="z-index:10;">
                                          <li class=""><a class="rounded-t bg-gray-50 hover:bg-gray-100 py-2 px-10 block whitespace-nowrap" href="CategoryItems.jsp?item=All">All</a></li>
                                          <li class=""><a class="bg-gray-50 hover:bg-gray-100 py-2 px-10 block whitespace-nowrap" href="CategoryItems.jsp?item=Paintings">Paintings</a></li>
                                          <li class=""><a class="bg-gray-50 hover:bg-gray-100 py-2 px-10 block whitespace-nowrap" href="CategoryItems.jsp?item=Drawings">Drawings</a></li>
                                          <li class=""><a class="bg-gray-50 hover:bg-gray-100 py-2 px-10 block whitespace-nowrap" href="CategoryItems.jsp?item=Calligraphy">Calligraphy</a></li>
                                          <li class=""><a class="bg-gray-50 hover:bg-gray-100 py-2 px-10 block whitespace-nowrap" href="CategoryItems.jsp?item=Decor">Decor</a></li>
                                          <li class=""><a class="bg-gray-50 hover:bg-gray-100 py-2 px-10 block whitespace-nowrap" href="CategoryItems.jsp?item=Jewelry">Jewelry</a></li>
                                          <li class=""><a class="rounded-b bg-gray-50 hover:bg-gray-100 py-2 px-10 block whitespace-nowrap" href="CategoryItems.jsp?item=Ceramics">Ceramics</a></li>
                                        </ul>
                                    </div>
                                </li>
                                <li>
                    ...
                    <div class="order-1 w-64 md:order-2">
                        <a class="flex justify-start mx-auto tracking-wide no-underline hover:no-underline font-bold text-gray-800 text-4xl" style="font-family:didot" href="LandingPage.jsp">
                            UNICUS
                        </a>
                    </div>
                    ...
                    <div class="order-2 md:order-3 flex items-center" id="nav-content">
                        ...
                        <div class="dropdown group inline-block relative">    
                            ...
                            <ul class="dropdown-menu absolute hidden text-gray-700 pt-1" style="z-index:10;">
                                <li class=""><a class="rounded-t bg-gray-50 hover:bg-gray-100 py-2 px-4 block whitespace-nowrap" href="Login.jsp">Login</a></li>
                            </ul>
                        </div>
                    ...
                    <div class="carousel-inner relative overflow-y:visible w-full">
                        ...
                        <div class="carousel-item absolute opacity-0 bg-cover bg-right" style="height:60vh;">
                            <div class="block h-full w-full mx-auto flex pt-6 md:pt-0 md:items-center bg-cover bg-right" style="background-image: url('https://cdn.pixabay.com/photo/2018/01/03/05/46/tee-3057632_1280.jpg');">
                                ...
                                <div class="container mx-auto">
                                    <div class="flex flex-col w-full lg:w-1/2 md:ml-16 items-center md:items-start px-6 tracking-wide">
                                        <p class="text-black text-2xl my-4">Ceramics </p>
                                        <a class="text-xl inline-block no-underline border-b border-gray-600 leading-relaxed hover:text-black hover:border-black" href="#">view product</a>
                                    </div>
                                </div>
                        ...
                        <div class="carousel-item absolute opacity-0 bg-cover bg-right" style="height:60vh;">
                            <div class="block h-full w-full mx-auto flex pt-6 md:pt-0 md:items-center bg-cover bg-right" style="background-image: url('https://cdn.pixabay.com/photo/2013/02/22/14/11/robert-duncanson-84959_1280.jpg');">
                                ...
                                <div class="container mx-auto">
                                    <div class="flex flex-col w-full lg:w-1/2 md:ml-16 items-center md:items-start px-6 tracking-wide">
                                        <p class="text-black text-2xl my-4">Oil Paintings</p>
                                        <a class="text-xl inline-block no-underline border-b border-gray-600 leading-relaxed hover:text-black hover:border-black" href="#">view product</a>
                                    </div>
                                </div>
                        ...
                        <div class="carousel-item absolute opacity-0" style="height:60vh;">
                            <div class="block h-full w-full mx-auto flex pt-6 md:pt-0 md:items-center bg-cover bg-bottom" style="background-image: url('https://cdn.pixabay.com/photo/2017/09/26/23/10/painting-2790478_1280.jpg');">
                                ...
                                <div class="container mx-auto">
                                    <div class="flex flex-col w-full lg:w-1/2 md:ml-16 items-center md:items-start px-6 tracking-wide">
                                        <p class="text-black text-2xl my-4">Drawings</p>
                                        <a class="text-xl inline-block no-underline border-b border-gray-600 leading-relaxed hover:text-black hover:border-black" href="#">view product</a>
                                    </div>
                                </div>
                        ...
                        <div class="carousel-item absolute opacity-0" style="height:60vh;">
                            <div class="block h-full w-full mx-auto flex pt-6 md:pt-0 md:items-center bg-cover bg-bottom" style="background-image: url('https://cdn.pixabay.com/photo/2019/11/30/21/37/stars-4664313_1280.jpg');">
                                ...
                                <div class="container mx-auto">
                                    <div class="flex flex-col w-full lg:w-1/2 md:ml-16 items-center md:items-start px-6 tracking-wide">
                                        <p class="text-black text-2xl my-4">Decor</p>
                                        <a class="text-xl inline-block no-underline border-b border-gray-600 leading-relaxed hover:text-black hover:border-black" href="#">view product</a>
                                    </div>
                                </div>
