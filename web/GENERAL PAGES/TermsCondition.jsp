        ...
        <main>    
            <section class="bg-gray-600 py-6">
                ...
                <div class="container py-6 px-6 mx-auto">
                    <p class="text-yellow-200 text-5xl text-center font-semibold" style="font-family:didot">Terms & Condition</p>
                </div>
            ...
            <section class="bg-white py-64">
                ...
                <div class="container py-64 px-6 mx-auto">
                    <div class="text-center mt-3">
                    <div align="left" class="items-left flex-1 flex flex-col justify-left pt-16 lg:pt-16 lg:pb-8" style="padding: 20px 40px">
                        <p>Welcome to UNICUS! Here is the Terms & Conditions of our service:</p>
                        <br><br>
                            <h2 style="font-weight: bold">1. Our mission is to provide an easy and simple bidding system where everyone can participate and enjoy arts to the fullest.</h2>
                                <p>UNICUS offers users service to become sellers and help you open your market to a wider scope. Seller can set their own value and pay according to income. The item post can be adjusted to match User's preferences.</p>
                                <br>
                            <h2 style="font-weight: bold">2. You own the content of your post.</h2>
                                <p>You grant us and other Users of UNICUS certain rights access to the content of your post. Any appropiate report of illegal or harmful items will taken action following the law</p>
                                <br>
                            <h2 style="font-weight: bold">3. You are responsible for the items you sell/buy.</h2>
                                <p>UNICUS only provice users with an easy-to-use platform for art online bidding. Any damage to the items are not in the scope of our responsibility</p>
                                <br>
                            <h2 style="font-weight: bold">4. We do not endorse or verify content posted by Users.</h2>
                                <p>Our services are provided to you "as is", without any guarantees. You are solely responsible for your own use of the UNICUS platform.</p>
                    </div>
