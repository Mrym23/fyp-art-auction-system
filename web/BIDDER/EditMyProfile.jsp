        ...
        <main class="flex h-screen">
            ...
            <aside class="w-56" aria-label="Sidebar">
                <div class="overflow-y-auto py-4 px-3 bg-white rounded dark:bg-gray-800">
                    <ul class="space-y-2">
                        <li>
                            <a href="Dashboard.jsp?id=<%=bidder_ID%>" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                                ...
                                <div class="px-10 pt-5 pb-10 mt-4 bg-white rounded shadow-xl">
                                    <div class="flex justify-between mb-3">
                                        ...
                                        <div class=" flex justify-between">     
                                            <button type="submit" name="command" value="update" class="px-4 py-1 text-gray-800 font-normal tracking-wider bg-yellow-300 rounded hover:bg-yellow-400">
                                    ...
                                    <div>
                                        <div>
                                            <label class="mt-4 block text-s text-gray-900" for="fullname">Full Name:</label>
                                            ...
                                            focus:outline-none" type="text" name="fullname" size="50" value="<%=bidder.getFullname()%>">
                                        </div>
                                    </div>
                                    <div>
                                        <label class="mt-4 block text-s text-gray-900" for="email">Email:
                                            <i class="fa fa-info-circle w-2 h-2 text-gray-600 hover:text-yellow-400 transition duration-150 ease-in-out mb-2" 
                                            data-bs-toggle="tooltip" title="Email cannot be modified."></i>
                                        </label>
                                        <input type="text" id="exampleFormControlInput5" aria-label="readonly input example" readonly
                                            class="form-control block w-full px-4 text-l text-gray-900 bg-white bg-clip-padding border 
                                            rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-yellow-400 
                                            focus:outline-none" type="text" name="email" size="50" value="<%=bidder.getEmail()%>"/>
                                    </div>
                                    <div>
                                        <div>
                                            <label class="mt-4 block text-s text-gray-900" for="password">Password:</label>
                                            <input class="form-control block w-full px-4 text-l text-gray-900 bg-white bg-clip-padding border 
                                            rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-yellow-400 
                                            focus:outline-none" type="text" name="password" size="30" value="<%=bidder.getPassword()%>">
                                        </div>
                                    </div>
                                </div>
                                </form>
