...
<body class="bg-white text-gray-600 work-sans leading-normal text-base tracking-normal">
    ...
    <div class="flex flex-col">
        <% 
            ...
            Address address = addressdao.retrieveAddressByAddress_ID(Integer.parseInt(address_ID));
        %>
        <!--Nav-->
        ...
        <main class="flex h-screen">
            ...
            <aside class="w-60" aria-label="Sidebar">
                <div class="overflow-y-auto py-4 px-3 bg-white rounded dark:bg-gray-800">
                    <ul class="space-y-2">
                        <li>
                            <a href="MyProfile.jsp?id=<%=address.getBidder_ID()%>" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                                <svg class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clip-rule="evenodd"></path></svg>
                                <span class="flex-1 ml-3 whitespace-nowrap">My Profile</span>
                            </a>
                        </li>
                        <li>
                            <a href="Activity.jsp?id=<%=address.getBidder_ID()%>" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                        ...
                        <li>
                            <a href="Orders.jsp?id=<%=address.getBidder_ID()%>" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                    ...
                    <ul class="pt-4 mt-4 space-y-2 border-t border-yellow-200 dark:border-yellow-200">
                        <li>
                            <a href="../sellerController?command=verify&hidid=<%=address.getBidder_ID()%>" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg transition duration-75 hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group">
                                 ...
                                 <div class="px-10 pt-4 pb-6 mt-4 bg-white rounded shadow-xl">
                                    <div class="flex justify-between mb-3">
                                        ...
                                        <div class=" flex justify-between">     
                                            <button type="submit" name="command" value="updateAddress" class="px-4 py-1 text-gray-800 font-normal tracking-wider bg-yellow-300 rounded hover:bg-yellow-400">
                                    ...
                                    <div class="flex flex-wrap">
                                        <div class="md:w-1/2 md:mb-0 pr-3">
                                            <div>
                                                ...
                                                focus:outline-none" type="text" name="name" size="50" value="<%=address.getName()%>">
                                            </div>
                                        </div>
                                        <div class="md:w-1/2">
                                            <div>
                                                ...
                                                <input class="form-control block w-full px-4 text-l text-gray-900 bg-white bg-clip-padding border 
                                                rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-yellow-400 
                                                focus:outline-none" type="text" name="contactNo" size="50" value="<%=address.getContactNo()%>">
                                            </div>
                                        </div>
                                    </div>
                                    <div>
                                        <div>
                                            ...
                                            <input class="form-control block w-full px-4 text-l text-gray-900 bg-white bg-clip-padding border 
                                            rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-yellow-400 
                                            focus:outline-none" type="text" name="addr1" size="50" value="<%=address.getAddr1()%>">
                                        </div>
                                    </div>
                                    <div>
                                        <div>
                                            ...
                                            <input class="form-control block w-full px-4 text-l text-gray-900 bg-white bg-clip-padding border 
                                            rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-yellow-400 
                                            focus:outline-none" type="text" name="addr2" size="50" value="<%=address.getAddr2()%>">
                                        </div>
                                    </div>
                                    <div>
                                        <div>
                                            ...
                                            <input class="form-control block w-full px-4 text-l text-gray-900 bg-white bg-clip-padding border 
                                            rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-yellow-400 
                                            focus:outline-none" type="text" name="city" size="50" value="<%=address.getCity()%>">
                                        </div>
                                    </div>
                                    <div>
                                        <div>
                                            ...
                                            <input class="form-control block w-full px-4 text-l text-gray-900 bg-white bg-clip-padding border 
                                            rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-yellow-400 
                                            focus:outline-none" type="text" name="state" size="50" value="<%=address.getState()%>">
                                        </div>
                                    </div>
                                    <div>
                                        <div>
                                            ...
                                            <input class="form-control block w-full px-4 text-l text-gray-900 bg-white bg-clip-padding border 
                                            rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-yellow-400 
                                            focus:outline-none" type="text" name="zipcode" size="50" value="<%=address.getZipCode()%>">
                                        </div>
                                    </div>
                                    <div>
                                        <div>
                                            <input class="w-full border rounded" type="hidden" name="hidid" value="<%=address.getAddress_ID()%>">
                                        </div>
                                    </div>
                                    <div>
                                        <div>
                                            <input class="w-full border rounded" type="hidden" name="hidbidderid" value="<%=address.getBidder_ID()%>">
                                        </div>
                                    </div>
                                 </div>
                                </form>
