<%-- 
    Document   : ItemsDetails
    Created on : Jun 18, 2022, 5:01:53 AM
    Author     : USER
--%>
    ...
    <body class="bg-white text-gray-600 work-sans leading-normal text-base tracking-normal">
        ...
        <div class="flex flex-col">
            <%
                ...
                String back_id = request.getParameter("backid");
                ...
                <section class="bg-gray-100 py-4">
                    ...
                    <div class="container mx-auto flex items-center flex-wrap pb-2">
                        ...
                        <nav id="store" class="w-full top-0 px-6 py-1">
                            <div class="w-full container mx-auto flex flex-wrap items-center justify-start text-gray-800 text-xl mt-0 px-2 py-3">

                                <a class="tracking-wide no-underline hover:no-underline text-gray-800 hover:text-black text-xl " href="Homepage.jsp?id=<%=bidder_ID%>">
                                            Home    
                                    </a>&nbsp /&nbsp Details
                                ...
                                <div class="flex flex-col bg-white rounded-lg shadow-xl w-1/2 md:w-9/20">
                                    ...
                                    <div class="inline-block flex flex-row justify-between items-center mx-7 relative">
                                        ...
                                        <div  x-data="{ modelOpen: false }" class="px-2 text-center justify-between flex flex-col md:flex-row items-center ">
                                            <button @click="modelOpen =!modelOpen" class="focus:outline-none text-center text-white px-8 bg-yellow-400 hover:bg-yellow-500 hover:text-gray-900 focus:ring-4 focus:ring-yellow-300 font-semibold rounded-lg text-base px-3 py-1.5 mb-2 dark:focus:ring-yellow-900">
                                                Bid
                                            </button>
                                                    ...
                                                    >
                                                        ...
                                                        <form class="mt-3" action="../BiddingController" method="POST">
                                                            <div>
                                                                ...
                                                                <input type="hidden" name="item" value="<%=Ctg%>" class="w-full px-4border rounded-md focus:outline-none focus:ring-1 focus:border-yellow-100 focus:ring-yellow-300">
                                                                <input type="hidden" name="backid" value="3" class="w-full px-4 border rounded-md focus:outline-none focus:ring-1 focus:border-yellow-100 focus:ring-yellow-300">
                                    ...
                                    <div class="justify-center inline-block flex flex-col py-3 md:flex-row items-center ">
                                        <button type="button" class="focus:outline-none inline-flex item-center text-white bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:focus:ring-yellow-900">
                                            <a href="Homepage.jsp?id=<%=bidder_ID%>">Back</a>
                                        </button>
                                    </div>
                                    <%
                                        }else{ 
                                    ...
                                    <div class="justify-center inline-block flex flex-col py-3 md:flex-row items-center ">
                                        <button type="button" class="focus:outline-none inline-flex item-center text-white bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:focus:ring-yellow-900">
                                            <a href="CategoryItems.jsp?id=<%=bidder_ID%>&item=<%=Ctg%>">Back</a>
                                        </button>
                                    </div>
                                    <%
                                        } 
