                        ...
                        <form action="../bidderController">
                            ...
                            <div class="field">
                                ...
                                <div class="field-body">
                                    <div class="field">
                                        <div class="control">
                                            <input type="email" autocomplete="on" name="email" readonly value="<%=admin.getEmail()%>" class="input is-static">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="field">
                                ...
                                <div class="field-body">
                                    <div class="field">
                                        <div class="control">
                                            <input type="text" autocomplete="on" name="password" value="<%=admin.getPassword()%>" class="input" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
