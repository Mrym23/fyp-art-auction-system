            ...
            <main>
                <div class="p-20 h-screen w-screen flex flex-col md:flex-row items-center justify-center bg-gradient-to-b from-gray-100 to-gray-200">
                    ...
                    <div class="container mx-auto flex flex-col items-center">
                        <form class="shadow-xl w-80 p-6 flex flex-col bg-white rounded-lg" name="form" action="<%=request.getContextPath()%>/bidderController" method="POST">
                            <div class="flex flex-col">
                                <input type="text" name="fullname" id="fullname" placeholder="Fullname" required class="mb-3 py-3 px-4 border border-gray-400 focus:outline-none rounded-md focus:ring-1 ring-gray-500" />
                                <input type="email" name="email" id="email" placeholder="Email" required class="mb-3 py-3 px-4 border border-gray-400 focus:outline-none rounded-md focus:ring-1 ring-gray-500" />
                                <input type="password" name="password" id="password" autocomplete="current-password" placeholder="Password" required class="mb-3 py-3 px-4 border border-gray-400 focus:outline-none rounded-md focus:ring-1 ring-gray-500" />
                                <input type="password" name="repassword" id="repassword" autocomplete="current-password" placeholder="Confirm Password" required class="mb-3 py-3 px-4 border border-gray-400 focus:outline-none rounded-md focus:ring-1 ring-gray-500" />
                                <button type="submit" name="command" value ="verify" onclick ="return validate()" class="w-full bg-gray-600 hover:bg-gray-800 text-white p-3 mb-4 rounded-lg font-semibold text-lg">Signup</button>
                            </div>
                            <div class="text-center text-md">
                                <span style="color:red">${errorEmail}</span>
                            </div>
                            <hr />
                            <p class="text-center text-sm mt-8 mb-1">
                                <span class="text-gray-800 text-center font-semibold">Already have an account?</span> Login NOW!
                            </p>
                            <button class="w-full bg-yellow-500 hover:bg-yellow-600 mb-2 text-white p-3 rounded-lg font-semibold text-lg"><a href="Login.jsp">Login</a></button>
                        </form>
                        <div class="w-80 px-6 flex flex-col">
                            <p class="text-center text-sm mt-4 mb-2">
                                <span class="font-semibold text-center w-full">Signing up</span> signifies you have read and agree to our
                            </p>
