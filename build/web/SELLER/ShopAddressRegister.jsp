...
<body class="bg-white text-gray-600 work-sans leading-normal text-base tracking-normal">
    ...
    <div class="flex flex-col">
        ...
        <main class="flex flex-col min-h-screen">
            ...
            <div class="flex flex-col flex-1 w-full h-full overflow-y-auto bg-gray-50 bg-opacity-50 items-center">
                <div class="px-6 py-6 mx-8 mt-4 mb-4 text-left bg-white shadow-lg rounded-lg md:w-1/3 lg:w-1/3 sm:w-1/3">
                    <h3 class="text-2xl font-bold text-center mt-4">Shop Address</h3>
                    <% 
                    ...
                    <form action="../sellerController" method="POST">
                        <div class="mt-8">
                            <div>
                                <div>
                                    <input type="hidden" name="hidid" value="<%=seller.getSellerId()%>"
                                ...
                                <div>
                                    <label class="block" for="contactNo">Contact Number<label>
                                        <input type="text" name="contactNo" placeholder="Contact Number" class="w-full px-4 py-2 mt-2 border rounded-md focus:outline-none focus:ring-1 focus:border-yellow-100 focus:ring-yellow-300">
                                </div>
                                <div class="mt-8">
                                    <label class="block" for="addr1">Address Line 1<label>
                                            <input type="text" name="addr1" placeholder="Address Line 1" class="w-full px-4 py-2 mt-2 border rounded-md focus:outline-none focus:ring-1 focus:border-yellow-100 focus:ring-yellow-300">
                                </div>
                                <div class="mt-8">
                                    <label class="block" for="addr2">Address Line 2<label>
                                            <input type="text" name="addr2" placeholder="Address Line 2" class="w-full px-4 py-2 mt-2 border rounded-md focus:outline-none focus:ring-1 focus:border-yellow-100 focus:ring-yellow-300">
                                </div>
                                <div class="mt-8">
                                    <label class="block" for="city">City<label>
                                            <input type="text" name="city" placeholder="City" class="w-full px-4 py-2 mt-2 border rounded-md focus:outline-none focus:ring-1 focus:border-yellow-100 focus:ring-yellow-300">
                                </div>
                                <div class="mt-8">
                                    <label class="block" for="state">State<label>
                                            <input type="text" name="state" placeholder="State" class="w-full px-4 py-2 mt-2 border rounded-md focus:outline-none focus:ring-1 focus:border-yellow-100 focus:ring-yellow-300">
                                </div>
                                <div class="mt-8">
                                    <label class="block" for="zipCode">Zip Code<label>
                                            <input type="text" name="zipCode" placeholder="Zip Code" class="w-full px-4 py-2 mt-2 border rounded-md focus:outline-none focus:ring-1 focus:border-yellow-100 focus:ring-yellow-300">
                                </div>
                            </div>
                            <div class="flex mt-3">
                                <button type="submit" name="command" value="saveAddress" class="w-full px-6 py-2 mt-6 text-white rounded-lg bg-gray-600 hover:bg-gray-800">Go to My Shop</button>
                            </div>
                        </div>
                    </form>
                </div>
