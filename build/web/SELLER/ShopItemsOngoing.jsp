<%-- 
    Document   : ShopItemsOngoing
    Created on : Jun 16, 2022, 2:03:29 AM
    Author     : USER
--%>
...
<body class="bg-white text-gray-600 work-sans leading-normal text-base tracking-normal">
    ...
    <div class="flex flex-col">
        ...
        <main class="flex h-screen relative">
            ...
            <div class="flex flex-col flex-1 w-full h-full overflow-y-auto bg-gray-200 bg-opacity-50 relative">
                    ...
                    <div class="justify-between inline-block flex flex-col md:flex-row items-center ">
                        ...
                        <div class="dropdown group inline-block relative">
                            ...
                            <ul class="dropdown-menu absolute hidden text-gray-700 pt-1" style="z-index:10;">
                                ...
                                <li><a class="bg-gray-50 hover:bg-gray-100 py-2 px-4 block whitespace-nowrap" href="AboutUs.jsp">Ongoing</a></li>
