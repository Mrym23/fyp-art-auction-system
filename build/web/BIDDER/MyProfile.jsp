...
<body class="bg-white text-gray-600 work-sans leading-normal text-base tracking-normal">
    ...
    <div class="flex flex-col">
        <%
            ...
            Bidder bidder = (Bidder) request.getSession().getAttribute("uBidder");
        %>
        <!--Nav-->
                                ...
                                <div class="px-10 pt-4 pb-10 mt-4 bg-white rounded shadow-xl">
                                    <div class="flex justify-between mb-3">
                                        <div>
                                            <p class="text-xl pb-3 flex text-gray-900 items-center">
                                                <i class="fas fa-list mr-3"></i> My Profile
                                            </p>
                                        </div>
                                        <div class=" flex justify-between">     
                                            <a href="EditMyProfile.jsp?id=<%=bidder.getBidder_ID()%>" class="px-4 py-1 text-gray-800 font-normal tracking-wider bg-yellow-300 rounded hover:bg-yellow-400">
                                    ...
                                    <div>
                                        <table class="text-left">
                                            <tr>
                                                <th class="font-normal text-gray-900">Full Name</th>
                                                <td class="pl-4"><%=bidder.getFullname()%></td>
                                            </tr>
                                            <tr>
                                                <th class="font-normal text-gray-900">Email</th>
                                                <td class="pl-4"><%=bidder.getEmail()%></td>
                                            </tr>
                                            <tr>
                                                <th class="font-normal text-gray-900">Password</th>
                                                <td class="pl-4" type="password"><%=bidder.getPassword()%></td>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
                            ...
                            <div class="w-full leading-loose">
                                <div class="px-10 pt-5 pb-10 mt-4 bg-white rounded shadow-xl">
                                    <div class="flex justify-between mb-3">
                                        ...
                                        <div class=" flex justify-between">     
                                            <a href="AddAddress.jsp?id=<%=bidder.getBidder_ID()%>" class="px-4 py-1 text-gray-800 font-normal tracking-wider bg-yellow-300 rounded hover:bg-yellow-400">
                                        ...
                                        <div>
                                            <table class="min-w-full leading-normal">
                                                ...
                                                <%
                                                    ...
                                                    List<Address> addressList = addressdao.retrieveAllAddressByBidder_ID(Integer.parseInt(bidder_ID));
                                                    ...
                                                    <tr>
                                                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                                            <div class="flex items-center">
                                                                <%=address.getName()%>, <%=address.getContactNo()%>
                                                            </div>
                                                            <div class="flex items-center">
                                                                <%=address.getAddr1()%>, <%=address.getAddr2()%>, <%=address.getCity()%>, <%=address.getState()%>, <%=address.getZipCode()%>
                                                            </div>
                                                        </td>
                                                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                                            <div class=" flex justify-end">
                                                                <button class="px-3 py-1 mr-2 text-white font-light tracking-wider bg-gray-600 rounded hover:bg-yellow-500">
                                                                        <a href="EditAddress.jsp?id=<%=address.getAddress_ID()%>">
                                                                            <i class="fas fa-edit"></i>
                                                                        </a>
                                                                </button>
                                                                <form action="../bidderController">
                                                                    <input type="hidden" name="hidAddrId" value="<%=address.getAddress_ID()%>">
                                                                    <input type="hidden" name="hidbidderId" value="<%=bidder.getBidder_ID()%>">
                                                                    <button type="submit" name="command" value="deleteAddress" class="px-3 py-1 text-white font-semibold tracking-wider bg-gray-600 hover:bg-yellow-500 rounded focus:outline-white">X</button>
                                                                </form>
                                                            </div>
                                                        </td>
                                                    </tr>
