<%-- 
    Document   : Orders
    Created on : Jun 26, 2022, 5:08:12 PM
    Author     : USER
--%>
...
<body class="bg-white text-gray-600 work-sans leading-normal text-base tracking-normal">
    ...
    <div class="flex flex-col">
        ...
        <main class="flex h-screen">
            ...
            <div class="flex flex-col flex-1  h-full overflow-y-auto bg-gray-300 bg-opacity-50">
                <div class="container mx-auto grid">
                    <div class="mt-4 ml-3 rounded">
                        
                        <div  class="ml-5 mr-12">
                            <p class="text-2xl mr-7 text-gray-900 flex ">
                                Orders &nbsp;&nbsp;|&nbsp;
                            </p>
                        </div>
                        <!-- Tabs -->
                        <ul id="tabs" class="inline-flex ml-5 mr-12 w-full pt-3 ">
                          <li class="px-4 py-2 bg-white -mb-px text-gray-800 border-b-2 border-yellow-500 rounded-t opacity-50"><a id="default-tab" href="#first">To Pay</a></li>
                          <li class="px-4 py-2 bg-white text-gray-800 rounded-t opacity-50"><a href="#second">To Receive</a></li>
                          <li class="px-4 py-2 bg-white text-gray-800 rounded-t opacity-50"><a href="#third">Completed</a></li>
                        </ul>
                        
                        <!-- Tab Contents -->
                        <div id="tab-contents" class="ml-5 mr-12">
                            <%
                                OrderDAO orderdao = new OrderDAOImpl();
                                List<Orders> ordersList = orderdao.retrieveAllOrderByBidderId(Integer.parseInt(bidder_id));
                                int countToPay = 1;
                                int countToRec = 1;
                                int countToRate = 1;
                                int countCompleted = 1; 
                            %>
                                ...
                                <table class="min-w-full leading-normal">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <%
                                                double totalAmount = orders.getShippingFee() + items.getPrice();
                                            %>
                                            <td class="px-2 py-3 border-b border-gray-200 bg-white text-sm">
                                                <div class="flex">
                                                    <p class="text-gray-900 whitespace-nowrap">
                                            ...
                                            <td class="px-2 py-3 border-b border-gray-200 bg-white text-sm">
                                                <div class="flex flex-row">
                                                    ...
                                                    <button class="rounded-lg px-3 py-1 text-gray-800 tracking-wider bg-yellow-300 hover:grow hover:bg-yellow-500 hover:text-black">
                                                        <a href="Payment.jsp?id=<%=orders.getOrderId()%>">Pay</a>
                                                    </button>
                                                </div>
                                            </td>
                                            <%
                            ...
                            <div id="second" class="hidden p-4 bg-white">
                                <table class="min-w-full leading-normal">
                                    <thead>
                                        <tr>
                                            <th class="px-1 py-3 border-b border-gray-400 text-center text-xs text-gray-600 uppercase tracking-wider">
                                    ...
                                    <tbody>
                                        <%
                                            if(orders.getStatus()!=null){
                                                if(orders.getStatus().equals("Paid")||orders.getStatus().equals("Posted")){
                                        %>
                                        <tr>
                                            <td class="px-1 py-2 text-center border-b border-gray-200 bg-white text-sm">
                                                <div class="">
                                            ...
                                            <td class="px-2 py-3 border-b border-gray-200 bg-white text-sm">
                                                <form action="../OrderController" method="POST">    
                                                    <div class="flex flex-row">
                                                        ...
                                                        <input type="hidden" name="bidid" value="<%=orders.getBidderId()%>" class="w-full px-4 py-2 mt-2">
                                                        <input type="hidden" name="status" value="Received" class="w-full px-4 py-2 mt-2">
                                                        <button class="rounded-lg px-3 py-1 mr-2 text-gray-800  tracking-wider bg-yellow-300 hover:grow hover:bg-yellow-500 hover:text-black" >
                                                            <a href="OrderDetails.jsp?id=<%=orders.getOrderId()%>"><i class="fa fa-list"></i></a>
                                                        </button>
                                                        <button type="submit" name="command" value="updateStatus" class="rounded-lg px-3 py-1 text-gray-800 tracking-wider bg-yellow-300 hover:grow hover:bg-yellow-500 hover:text-black" >
                                                            Received
                                                        </button>
                                                    </div>
                                                </form>
                            ...
                            <div id="third" class="hidden p-4 bg-white">
                                <table class="min-w-full leading-normal">
                                    <thead>
                                        <tr>
                                            <th class="px-1 py-3 border-b border-gray-400 text-center text-xs text-gray-600 uppercase tracking-wider">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <%
                                                Double total = orders.getShippingFee() + items.getPrice();
                                            %>
                                            <td class="px-2 py-3 border-b border-gray-200 bg-white text-sm">
                                                <div class="flex">
                                                    <p class="text-gray-900 whitespace-nowrap">
        ...
        tabTogglers.forEach(function(toggler) {
          toggler.addEventListener("click", function(e) {
            ...
            for (let i = 0; i < tabContents.children.length; i++) {
              ...
              tabTogglers[i].parentElement.classList.remove("border-yellow-500", "border-b",  "-mb-px", "opacity-100");  tabContents.children[i].classList.remove("hidden");
